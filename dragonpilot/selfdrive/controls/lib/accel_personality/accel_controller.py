...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-.002, -.003, -0.25, -0.27, -0.31, -0.45, -0.70, -2.0],
  AccelPersonality.normal: [-.002, -.003, -0.26, -0.29, -0.33, -0.50, -0.80, -2.0],
  AccelPersonality.sport:  [-.002, -.003, -0.26, -0.29, -0.33, -0.55, -0.85, -2.0],
}
# 對應最大減速度的車速節點 (單位: m/s)
